  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      role: '',
      description: [
        'Susantha Weerappuli, a distinguished Co-founder of Ceylon Naturalist, shares a profound connection with the untamed beauty of the wilderness, where elephants roam freely, and birds serenade the surroundings.',
    ...
    },
    {
      ...
      role: '',
      description: [
        'Suneth Bashitha Dilshan, still a young nature enthusiast, is co-founder of Ceylon Naturalist alongside his father, Susantha Weerappuli.',
        ...
        'Beyond his personal interests, Suneth’s commitment to environmental appreciation is evident. As the operational manager of Ceylon Naturalist, he leverages not only his naturalist skills but also his professional acumen gained from as an auditor at EY.',
        ...
        'With the family being avid birdwatchers, Suneth’s leadership ensures that Ceylon Naturalist thrives as a platform sharing the beauty of Sri Lanka’s birdlife with the world. Suneth embodies a harmonious convergence of professional excellence and a deep-seated passion for preserving and celebrating the natural world.',
      ],
