  ...
  return (
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          <h2 className="text-3xl font-semibold text-blackfont-[Poppins]  mb-8">A Biodiversity Haven</h2>
          <p className="text-black leading-relaxed font-[Poppins] mb-8 text-lg">
          ...
          <h3 className="text-2xl font-semibold text-black font-[Poppins]  mb-6">Migratory Gateway</h3>
          <p className="text-black leading-relaxed mb-8 font-[Poppins] text-lg">
          ...
          <h3 className="text-2xl font-semibold font-[Poppins]  text-black mb-6">Rich Natural Heritage</h3>
          <p className="text-black font-[Poppins] leading-relaxed mb-12 text-lg">
        ...
        <motion.div 
          ...
          className="prose prose-lg max-w-none mb-16"
        >
          <h3 className="text-2xl font-semibold text-black font-[Poppins] mb-6">Cultural Legacy</h3>
          <p className="text-black leading-relaxed font-[Poppins]  mb-8 text-lg">
          ...
          <h3 className="text-2xl font-semibold font-[Poppins] text-black mb-6">Natural Paradise</h3>
          <p className="text-black leading-relaxed font-[Poppins] mb-8 text-lg">
        ...
        >
          <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-sm">
            ...
            <p className="text-sm font-[Poppins] text-gray-600">Bird Species</p>
          </div>
          <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-sm">
            <Mountain className="w-8 h-8 text-gray-700 mb-2" />
            <p className="text-2xl  font-bold text-black">2500m</p>
            <p className="text-sm font-[Poppins] text-gray-600">Max Elevation</p>
          </div>
          <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-sm">
          ...
          <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-sm">
            ...
            <p className="text-sm font-[Poppins] text-gray-600">Years of History</p>
          </div>
        </motion.div>
      </div>
      <div>
